            ...
            <div className="text-center md:text-left">
              ...
              <MotionWrapper delay={0.2}>
                <p className="mt-8 text-lg md:text-xl text-gray-300 max-w-lg mx-auto md:mx-0">
                  캐릭터들과 도란도란 진짜 개발자처럼 말하는 AI 친구들과 커피 한
                  잔 하는 느낌으로, 편하게 개발 이야기를 나누는 공간입니다.
                </p>
              </MotionWrapper>
      ...
      {personas.length > 0 && (
        <Section className="bg-slate-700">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold tracking-tight">
              개성 만점!{" "}
              <span className="text-orange-400">당신을 기다리는 AI 친구들</span>
            </h2>
            <p className="mt-4 text-gray-400 text-lg">
          ...
          <div className="space-y-20">
            {personas.map((persona, index) => (
              <MotionWrapper key={persona.id} delay={index * 0.2}>
                <div
