...
export class Auth1762427279103 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."user_provider_enum" AS ENUM('local', 'kakao', 'google')`);
        ...
        await queryRunner.query(`CREATE TABLE "chats" ("id" SERIAL NOT NULL, "roomId" integer NOT NULL, "userId" character varying NOT NULL, "personaId" integer, "author" character varying NOT NULL, "content" text NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_0117647b3c4a4e5ff198aeb6206" PRIMARY KEY ("id"))`);
